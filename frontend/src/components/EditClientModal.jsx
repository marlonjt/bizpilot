        ...
        <form onSubmit={handleUpdateSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 mt-8 pt-4 border-t border-gray-700">
            ...
            <button
              type="submit"
              disabled={isUpdateInProgress}
              className="bg-indigo-600 hover:bg-indigo-500 text-white px-6 py-2 rounded-lg text-sm font-bold shadow-lg shadow-indigo-500/20 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
            >
