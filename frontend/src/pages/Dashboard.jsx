...
function Dashboard() {
  ...
  const [selectedClient, setSelectedClient] = useState(null); // null = no modal, object = edit modal

  // Fetches all clients from the API and updates local state.
  ...
  const handleEdit = (client) => {
    setSelectedClient(client); // Opens the edit modal with this client's data
  };
  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      {/* Edit modal — only mounted when a client is selected */}
      {selectedClient && (
        <EditClientModal
